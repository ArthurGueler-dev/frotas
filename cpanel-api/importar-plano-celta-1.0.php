<?php
/**
 * Script para importar Plano de Manutencao Chevrolet Celta 1.0 VHCE Flex
 * Gerado via Perplexity AI em 2026-01-14
 *
 * Acesso: https://floripa.in9automacao.com.br/importar-plano-celta-1.0.php?confirmar=SIM
 */
...
if (!isset($_GET['confirmar']) || $_GET['confirmar'] !== 'SIM') {
    ...
    echo json_encode([
        ...
        'url_exemplo' => 'https://floripa.in9automacao.com.br/importar-plano-celta-1.0.php?confirmar=SIM'
    ], JSON_PRETTY_PRINT);
    exit();
}
...
Drenagem completa do oleo lubrificante do motor VHCE (Variable High Compression Engine) 1.0 8V Flex atraves do bujao do carter. Substituicao do filtro de oleo tipo rosqueavel codigo GM 94632619 e reabastecimento com oleo semissintetico especificacao SAE 5W-30 API SN (recomendado) ou SAE 10W-40 API SM como alternativa. Capacidade: 3,0 litros com filtro. O motor VHCE possui taxa de compressao variavel que exige oleo de baixa viscosidade para partida a frio e economia de combustivel. **Criterio: o que ocorrer primeiro (10.000 km OU 12 meses)**.

**Criticidade:** CRITICA - Motor com taxa de compressao variavel requer lubrificacao premium constante.
...
[PECAS]
ORIGINAL|94632619|Filtro de Oleo Motor GM Celta 1.0|1|65.00
ORIGINAL|98550168|Oleo Motor ACDelco 5W-30 Sintetico|3L|165.00
SIMILAR|WO130|Wega|Filtro Oleo Celta 1.0 VHCE|1|25.00
SIMILAR|PSL947|Tecfil|Filtro Oleo Celta 1.0|1|23.00
SIMILAR|PH6018|Fram|Filtro Oleo Celta 1.0|1|27.00
SIMILAR|W610/3|Mann|Filtro Oleo Celta 1.0|1|29.00
SIMILAR|HELIX-HX7-5W30|Shell|Oleo Helix HX7 5W-30 Semissintetico|3L|95.00
SIMILAR|MAGNATEC-5W30|Castrol|Oleo Magnatec 5W-30 API SN|3L|105.00
SIMILAR|MOBIL-SUPER-5W30|Mobil|Oleo Mobil Super 3000 5W-30|3L|115.00
SIMILAR|LUBRAX-TECNO-5W30|Petrobras|Oleo Lubrax Tecno 5W-30|3L|88.00
[/PECAS]'
        ],
...
Substituicao do elemento filtrante de ar do motor VHCE 1.0 localizado na caixa de ar. Codigo original GM: 93260511. O filtro retem particulas solidas impedindo entrada no coletor de admissao e camara de combustao. Motor VHCE com injecao eletronica multiponto e taxa de compressao variavel requer fluxo de ar limpo para perfeita mistura ar/combustivel. Verificar estado da vedacao e limpeza interna da caixa de ar. Dimensoes: 291mm x 134mm x 39mm.
...
[PECAS]
ORIGINAL|93260511|Filtro Ar Motor GM Celta 1.0|1|88.00
SIMILAR|C1944|Mann|Filtro Ar Celta Prisma 1.0 1.4|1|42.00
SIMILAR|ARL8834|Tecfil|Filtro Ar Celta 1.0|1|38.00
SIMILAR|FAP3289|Wega|Filtro Ar Celta 1.0|1|35.00
SIMILAR|CA10813|Fram|Filtro Ar Celta 1.0|1|40.00
[/PECAS]'
        ],
...
[PECAS]
ORIGINAL|25FC0225|Filtro Combustivel ACDelco Celta|1|78.00
SIMILAR|GI04/6|Tecfil|Filtro Combustivel Celta 1.0|1|35.00
SIMILAR|JFC235|Wega|Filtro Combustivel Celta 1.0|1|32.00
SIMILAR|G5835|Fram|Filtro Combustivel Celta 1.0|1|38.00
SIMILAR|WK58/1|Mann|Filtro Combustivel Celta 1.0|1|40.00
[/PECAS]'
        ],
...
Substituicao das 4 velas de ignicao do motor VHCE 1.0 8V Flex. Utilizar velas codigo GM 93363296, NGK BR8ES ou Bosch F000KE0P32. Especificacoes: rosca longa 19mm, diametro 14mm, hexagono 20,8mm, grau termico 8, construcao resistiva. Motor Flex requer velas especificas resistentes a corrosao do etanol. Limpar bem a regiao antes da remocao. Aplicar torque de aperto de 25 Nm. Verificar cor dos eletrodos (branco = mistura pobre, preto = mistura rica, marrom claro = ideal).
...
[PECAS]
ORIGINAL|93363296|Jogo Velas Ignicao GM Celta 1.0 VHCE|4|165.00
SIMILAR|BR8ES|NGK|Jogo 4 Velas Ignicao Celta 1.0 Flex|4|75.00
SIMILAR|F000KE0P32|Bosch|Jogo 4 Velas Ignicao Celta 1.0|4|82.00
SIMILAR|PI0108|Peca Nova|Jogo 4 Velas Ignicao Celta 1.0|4|78.00
[/PECAS]'
        ],
...
Execucao de rodizio dos pneus 175/70 R13 (medida padrao Celta) conforme padrao paralelo ou cruz. Verificacao de pressao (30 PSI dianteiros e traseiros sem carga, 32 PSI com carga). Inspecao de desgaste irregular indicando necessidade de alinhamento. Verificacao de cortes, bolhas, deformacoes. Alinhamento 3D das rodas dianteiras (veiculo nao possui regulagem traseira). Balanceamento eletronico das 4 rodas se necessario.
...
[PECAS]
ORIGINAL|93160364|Fluido de Freio DOT 3 GM|500ML|42.00
SIMILAR|DOT3-500ML|Bosch|Fluido Freio DOT 3|500ML|25.00
SIMILAR|DOT3-CASTROL|Castrol|Fluido Freio DOT 3|500ML|28.00
SIMILAR|DOT3-TRW|TRW|Fluido Freio DOT 3|500ML|23.00
SIMILAR|DOT4-ATE|ATE|Fluido Freio DOT 4|500ML|30.00
[/PECAS]'
        ],
...
Substituicao da correia do alternador (correia poly-V). Motor VHCE 1.0 utiliza correia unica acionando alternador e bomba de direcao hidraulica (quando equipado, versoes basicas tem direcao mecanica sem correia). Verificacao do estado do tensionador automatico, polia lisa e rolamentos. Inspecao visual de trincas, desgaste das nervuras, vitrificacao. Tensionamento adequado conforme especificacao.

**Criticidade:** MEDIA - Correia desgastada pode romper.

**Consequencias de nao fazer:** Rompimento da correia causando descarregamento da bateria, perda de direcao assistida (se hidraulica), possivel superaquecimento se houver sobrecarga eletrica prolongada, necessidade de guincho.

[PECAS]
ORIGINAL|93363185|Correia Alternador GM Celta 1.0|1|88.00
SIMILAR|4PK840|Gates|Correia Poly-V Alternador Celta|1|38.00
SIMILAR|4PK840-CONT|Continental|Correia Poly-V Celta 1.0|1|35.00
SIMILAR|K040840|Dayco|Correia Alternador Celta 1.0|1|37.00
SIMILAR|4PK840-GY|Goodyear|Correia Auxiliar Celta 1.0|1|33.00
[/PECAS]'
        ],
...
[PECAS]
ORIGINAL|93384816|Jogo Pastilhas Freio Diant GM Celta|1|168.00
SIMILAR|N377|Cobreq|Jogo Pastilhas Freio Diant Celta 1.0|1|75.00
SIMILAR|HQJ3001PA|Jurid|Jogo Pastilhas Freio Diant Celta|1|82.00
SIMILAR|HI1377|Fras-le|Jogo Pastilhas Freio Diant Celta|1|78.00
SIMILAR|BB1377|Bosch|Jogo Pastilhas Freio Diant Celta|1|85.00
[/PECAS]'
        ],
...
**Consequencias de nao fazer:** Fluido contaminado causa corrosao interna do radiador, bloco, cabecote e bomba d agua, formacao de borra reduzindo eficiencia termica, superaquecimento, danos ao radiador, bomba d agua (R$ 200 a R$ 380) e motor, possivel empenamento do cabecote.

[PECAS]
ORIGINAL|93302891|Aditivo Radiador Dex-Cool GM|3L|105.00
ORIGINAL|AGUA-DESM|Agua Desmineralizada|3L|18.00
SIMILAR|PARAFLU-LL|Repsol|Aditivo Radiador Longa Duracao|3L|55.00
SIMILAR|COOLANT-LL|Wurth|Aditivo Radiador Organico|3L|58.00
SIMILAR|RAD-PROTEC|Valvoline|Aditivo Radiador Universal|3L|52.00
[/PECAS]'
        ],
...
**ITEM CRITICO DE SEGURANCA DO MOTOR.** Substituicao obrigatoria da correia dentada de sincronismo (111 dentes), tensor automatico e polia tensora. Kit Gates codigo CT874K3. O motor VHCE 1.0 8V e do tipo INTERFERENTE: caso a correia se rompa, os pistoes colidem com as valvulas causando danos catastroficos. Manual GM recomenda troca entre 40.000 e 60.000 km. **Recomendacao forte: trocar aos 50.000 km em uso urbano intenso**. Procedimento exige ferramentas especiais de sincronismo. Substituir tambem bomba d agua preventivamente (acionada pela correia, economia de mao de obra).
...
[PECAS]
ORIGINAL|93396203|Correia Dentada GM Celta 1.0 111 dentes|1|265.00
...
ORIGINAL|93271922|Bomba D Agua GM Celta 1.0|1|345.00
SIMILAR|CT874K3|Gates|Kit Correia Dentada Celta 1.0 Completo|1|425.00
SIMILAR|TB874|Dayco|Correia Dentada Celta 1.0|1|155.00
SIMILAR|T43874|Gates|Tensor Automatico Celta 1.0|1|225.00
SIMILAR|PA7874|Nakata|Polia Tensora Celta 1.0|1|105.00
SIMILAR|WP874|Nakata|Bomba D Agua Celta 1.0 8V|1|165.00
SIMILAR|PA874|Urba|Bomba D Agua Celta 1.0|1|185.00
[/PECAS]'
        ],
...
[PECAS]
ORIGINAL|93384816|Jogo Pastilhas Freio Diant GM Celta|1|168.00
ORIGINAL|93271925|Par Discos Freio Diant GM Celta|2|385.00
SIMILAR|N377|Cobreq|Jogo Pastilhas Freio Diant Celta 1.0|1|75.00
SIMILAR|HQJ3001PA|Jurid|Jogo Pastilhas Freio Diant Celta|1|82.00
SIMILAR|DF2377|Fremax|Par Discos Freio Solido Celta|2|225.00
SIMILAR|RC2377|Cobreq|Par Discos Freio Diant Celta|2|215.00
SIMILAR|BD2377|TRW|Par Discos Freio Celta 1.0|2|235.00
[/PECAS]'
        ],
...
Servico completo conforme especificacoes anteriores. Motor VHCE 1.0 Flex requer manutencao rigorosa para garantir funcionamento do sistema de compressao variavel.
...
[PECAS]
ORIGINAL|93384821|Jogo Lonas Freio Traseiro GM Celta|1|148.00
ORIGINAL|93271928|Par Tambores Freio Traseiro GM Celta|2|355.00
SIMILAR|HI1378|Fras-le|Jogo Lonas Freio Traseiro Celta|1|68.00
SIMILAR|N1378|Cobreq|Jogo Lonas Freio Traseiro Celta|1|63.00
SIMILAR|TT2378|TRW|Par Tambores Freio Traseiro Celta|2|205.00
SIMILAR|RT2378|Fremax|Par Tambores Freio Traseiro Celta|2|195.00
[/PECAS]'
        ],
...
[PECAS]
ORIGINAL|93271930|Amortecedor Dianteiro GM Celta|2|565.00
ORIGINAL|93271931|Amortecedor Traseiro GM Celta|2|535.00
SIMILAR|HG32145|Monroe|Amortecedor Diant Celta Gas|2|365.00
SIMILAR|HG32146|Monroe|Amortecedor Tras Celta Gas|2|345.00
SIMILAR|AM32145|Cofap|Amortecedor Diant Celta Turbogas|2|305.00
SIMILAR|AM32146|Cofap|Amortecedor Tras Celta Turbogas|2|285.00
SIMILAR|N32145|Nakata|Amortecedor Diant Celta 1.0|2|275.00
SIMILAR|N32146|Nakata|Amortecedor Tras Celta 1.0|2|255.00
[/PECAS]'
        ],
...
Substituicao da bateria automotiva 12V. Chevrolet Celta 1.0 utiliza bateria de 40Ah a 45Ah com corrente de partida (CCA) de 330A a 380A. Baterias seladas livre de manutencao tem vida util de 3 a 5 anos. Teste de carga e alternador antes da troca. Limpeza dos terminais e aplicacao de graxa protetora.
...
SIMILAR|CARB-CLEAN|Wurth|Limpador TBI/Admissao|500ML|45.00
SIMILAR|INTAKE-CLEAN|Bardahl|Limpador Sistema Admissao|300ML|52.00
[/PECAS]'
        ],
...
Chevrolet Celta utiliza pneus 175/70 R13 (medida padrao). Vida util media: 35.000 a 45.000 km ou 5 anos (o que vier primeiro). Borracha envelhece mesmo sem uso (oxidacao, ressecamento). Verificar mensalmente: pressao (30 PSI dianteiros e traseiros sem carga, 32 PSI com carga), desgaste da banda (minimo legal 1,6mm medido nos TWI), deformacoes, cortes laterais, data de fabricacao (codigo DOT). Realizar rodizio a cada 10.000 km.
...
[PECAS]
SIMILAR|175/70R13-PIR|Pirelli|Pneu Cinturato P1 175/70 R13|4|1080.00
SIMILAR|175/70R13-GY|Goodyear|Pneu Direction Touring 175/70 R13|4|980.00
SIMILAR|175/70R13-DUN|Dunlop|Pneu SP Touring R1 175/70 R13|4|920.00
SIMILAR|175/70R13-CONT|Continental|Pneu ContiPowerContact 175/70 R13|4|1020.00
SIMILAR|175/70R13-BRI|Bridgestone|Pneu Turanza ER300 175/70 R13|4|1040.00
[/PECAS]'
        ],
        ...
        [
            ...
            0.00,
            'Alta',
            '[CATEGORIA: Atencao Especial] [TEMPO: Verificacao 10 minutos]
...
**PREVENCAO:**
- **SEMPRE utilizar oleo 5W-30 API SN ou superior**
...
**ATENCAO MAXIMA:** A correia dentada do Celta 1.0 VHCE e o item de manutencao mais critico. Motor interferente: ruptura causa colisao entre pistoes e valvulas. **Casos documentados de ruptura antes dos 60.000 km em uso urbano severo.**
...
**PREVENCAO:**
- **Troca obrigatoria entre 40.000 e 60.000 km**
- **Recomendacao forte: 50.000 km em uso urbano**
- SEMPRE substituir tensor e polia tensora junto
- Substituir bomba d agua preventivamente
