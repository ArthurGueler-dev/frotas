<?php
/**
 * Registrar Peças da S10 na Tabela de Compatibilidade
 * Detecta automaticamente o nome correto do modelo
 *
 * Executar: https://floripa.in9automacao.com.br/registrar-compatibilidade-s10.php?confirmar=SIM
 */
...
if (count($pecas) === 0) {
    echo json_encode([
        'success' => false,
        'error' => 'Nenhuma peça da S10 encontrada',
        'sugestao' => 'Execute primeiro: importar-pecas-s10-perplexity.php'
    ], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    exit;
}
