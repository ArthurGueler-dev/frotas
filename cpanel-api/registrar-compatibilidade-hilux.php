<?php
/**
 * Registrar Peças da Hilux na Tabela de Compatibilidade
 * Detecta automaticamente o nome correto do modelo
 *
 * Executar: https://floripa.in9automacao.com.br/registrar-compatibilidade-hilux.php?confirmar=SIM
 */
...
if (count($pecas) === 0) {
    echo json_encode([
        'success' => false,
        'error' => 'Nenhuma peça da Hilux encontrada',
        'sugestao' => 'Execute primeiro: importar-pecas-hilux-perplexity.php'
    ], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    exit;
}
