<?php
/**
 * Registrar Peças do Mobi na Tabela de Compatibilidade
 * Detecta automaticamente o nome correto do modelo
 *
 * Executar: https://floripa.in9automacao.com.br/registrar-compatibilidade-mobi.php?confirmar=SIM
 */
...
if (!$modeloExistente) {
    // Se não existe, usar o nome padrão
    $modelo_veiculo = 'MOBI 1.0 Like';
} else {
...
if (count($pecas) === 0) {
    echo json_encode([
        'success' => false,
        'error' => 'Nenhuma peça do Mobi encontrada',
        'sugestao' => 'Execute primeiro: importar-pecas-mobi-perplexity.php'
    ], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    exit;
}
